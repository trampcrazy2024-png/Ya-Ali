#!/usr/bin/env bash
# بازنویسی کامل apps/mobile/src/services/endpointPersistence.ts (فایل صفر بایتی)
# اجرا از ریشه‌ی ریپو: cd /workspaces/Ya-Ali && bash write_endpointPersistence.sh
set -e
...
echo "✅ endpointPersistence.ts بازنویسی شد."
