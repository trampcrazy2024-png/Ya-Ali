...
- ONNX Runtime GenAI: export a compatible model to ONNX and package the GenAI model/tokenizer files; Ya-Ali can import a ZIP bundle containing the directory.
